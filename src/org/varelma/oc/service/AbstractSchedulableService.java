 ...
 * @author jon pallas
 */
public abstract class AbstractSchedulableService extends GenericService implements Schedulable, SimpleSchedulableService {
    ...
    public AbstractSchedulableService() {
    }
